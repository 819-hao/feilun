...
@Slf4j
@Component
public class FinancialInvoiceUpdateProducers {
    public static final String NAME_SERVER = "mq.local.com:9876";
    private static final String FINANCIAL_INVOICE_NOTICE_TOPIC = "feilunInvoiceMaycurUpdate";
    ...
    public void init() throws MQClientException {
        ...
        // 设置实例化名称
        producer.setInstanceName("FinancialInvoiceUpdateProducers");
     ...
     */
    public void sendMsg(FeilunInvoiceMaycurUpdateMessage deliveryMessage) {
        ...
        try {
            ...
            log.error("invoice_update_mq_error{}:{}", JSONObject.parse(message.getBody()), e.getMessage(), e);
        }
    }
