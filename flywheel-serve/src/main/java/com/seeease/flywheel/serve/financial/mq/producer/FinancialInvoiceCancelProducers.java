...
@Slf4j
@Component
public class FinancialInvoiceCancelProducers {
    public static final String NAME_SERVER = "mq.local.com:9876";
    private static final String FINANCIAL_INVOICE_NOTICE_TOPIC = "feilunInvoiceMaycurCancel";
    ...
    public void init() throws MQClientException {
        ...
        // 设置实例化名称
        producer.setInstanceName("FinancialInvoiceCancelProducers");
     ...
     */
    public void sendMsg(FeilunInvoiceMaycurCancelMessage deliveryMessage) {
