...
@Slf4j
@Component
public class SaleOrderDeliveryProducers {
    public static final String NAME_SERVER = "mq.local.com:9876";
    private static final String SALE_ORDER_DELIVERY_NOTICE_TOPIC = "saleOrderDeliveryNotice";
    ...
    public void init() throws MQClientException {
        producer = new DefaultMQProducer(SALE_ORDER_DELIVERY_NOTICE_TOPIC);
        // 设置实例化名称
        producer.setInstanceName("SaleOrderDeliveryProducer");
     ...
     */
    public void sendMsg(SaleOrderDeliveryMessage deliveryMessage) {

        byte[] body = JSONObject.toJSONBytes(deliveryMessage);

        Message message = new Message(SALE_ORDER_DELIVERY_NOTICE_TOPIC, body);
        try {
