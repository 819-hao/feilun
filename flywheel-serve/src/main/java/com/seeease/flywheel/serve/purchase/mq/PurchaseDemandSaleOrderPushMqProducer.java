...
@Slf4j
@Component
public class PurchaseDemandSaleOrderPushMqProducer {
    public static final String NAME_SERVER = "mq.local.com:9876";
    private static final String GOODS_META_INFO_SYNC_NOTICE_TOPIC = "purchaseDemandSaleOrderMq";
    ...
    public void init() throws MQClientException {
        ...
        // 设置实例化名称
        producer.setInstanceName("purchaseDemandSaleOrderProducer");
        // 设置服务器地址
     ...
     * @param infoSync
     */
    public void sendMsg(PurchaseDemandSaleOrderMqPushDto dto) {
