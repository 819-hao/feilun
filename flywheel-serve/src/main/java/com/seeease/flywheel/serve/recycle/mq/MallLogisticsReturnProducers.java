...
@Slf4j
@Component
public class MallLogisticsReturnProducers {
    public static final String NAME_SERVER = "mq.local.com:9876";
    private static final String MALL_LOGISTICS_RETURN_NOTICE_TOPIC = "mallLogisticsReturnNotice";
    ...
    public void init() throws MQClientException {
        producer = new DefaultMQProducer(MALL_LOGISTICS_RETURN_NOTICE_TOPIC);
        // 设置实例化名称
        producer.setInstanceName("MallLogisticsReturnProducers");
    ...
    public void sendMsg(RecycleMessage recycleMessage) {
        ...
        Message message = new Message(MALL_LOGISTICS_RETURN_NOTICE_TOPIC, body);
        try {
