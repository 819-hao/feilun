...
import com.seeease.flywheel.express.entity.FeilunInvoiceMaycurQryMessage;
...
@Slf4j
@Component
public class FinancialInvoiceQryProducers {
    public static final String NAME_SERVER = "mq.local.com:9876";
    private static final String FINANCIAL_INVOICE_NOTICE_TOPIC = "feilunInvoiceMaycurQry";
    ...
    public void init() throws MQClientException {
        ...
        // 设置实例化名称
        producer.setInstanceName("FinancialInvoiceQryProducers");
     ...
     */
    public void sendMsg(FeilunInvoiceMaycurQryMessage deliveryMessage) {
