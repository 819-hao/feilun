...
@Slf4j
@Component
public class MallPayOrderProducers {
    public static final String NAME_SERVER = "mq.local.com:9876";
    private static final String MALL_PAY_ORDER_NOTICE_TOPIC = "mallPayOrderNotice";
    ...
    public void init() throws MQClientException {
        producer = new DefaultMQProducer(MALL_PAY_ORDER_NOTICE_TOPIC);
        // 设置实例化名称
        producer.setInstanceName("MallPayOrderProducers");
    ...
    public void sendMsg(RecycleMessage recycleMessage) {
        ...
        Message message = new Message(MALL_PAY_ORDER_NOTICE_TOPIC, body);
        try {
