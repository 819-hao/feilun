 ...
 */
@Service
@Extension(bizId = BizCode.SHOP, useCase = UseCase.DELIVERY_LIST)
public class ShopWorkDeliveryListQueryExt implements QueryExtPtI<StoreWorkListRequest> {
    ...
    public QueryResult query(QueryCmd<StoreWorkListRequest> cmd) {
        ...
        PageResult<StoreWorkListResult> result = storeWorkQueryFacade.listDelivery(request);
