 ...
 */
@Service
@Extension(bizId = BizCode.TO_B_SALE_RETURN, useCase = UseCase.QUERY_LIST)
public class SaleReturnOrderListQueryExtToB implements QueryExtPtI<SaleReturnOrderListRequest> {
