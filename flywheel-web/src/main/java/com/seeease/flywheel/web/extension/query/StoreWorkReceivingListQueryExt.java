 ...
 */
@Service
@Extension(bizId = BizCode.STORAGE, useCase = UseCase.RECEIVING_LIST)
public class StoreWorkReceivingListQueryExt implements QueryExtPtI<StoreWorkListRequest> {
    ...
    public List<TaskDefinitionKeyEnum> needQueryTaskKeys(QueryCmd<StoreWorkListRequest> cmd) {
        return Lists.newArrayList(TaskDefinitionKeyEnum.LOGISTICS_RECEIVING);
    }
