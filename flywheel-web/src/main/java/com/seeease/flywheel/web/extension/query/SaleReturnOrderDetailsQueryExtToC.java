 ...
 */
@Service
@Extension(bizId = BizCode.TO_C_SALE_RETURN, useCase = UseCase.QUERY_DETAILS)
public class SaleReturnOrderDetailsQueryExtToC implements QueryExtPtI<SaleReturnOrderDetailsRequest> {
    ...
    public List<TaskDefinitionKeyEnum> needQueryTaskKeys(QueryCmd<SaleReturnOrderDetailsRequest> cmd) {
        return Lists.newArrayList(TaskDefinitionKeyEnum.UPLOAD_TO_C_RETURN_EXPRESS_NUMBER);
    }
}
